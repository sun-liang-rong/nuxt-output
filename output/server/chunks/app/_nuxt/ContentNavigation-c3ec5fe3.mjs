...
import { u as useAsyncData } from './asyncData-20625161.mjs';
import { e as useState, d as useRuntimeConfig } from '../server.mjs';
import { hash } from 'ohash';
import { _ as __nuxt_component_0 } from './nuxt-link-563b35af.mjs';
import { q as queryContent, e as encodeQueryParams, j as jsonStringify } from './query-bf1c20aa.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-893a42d4.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-d2891edd.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-c3ec5fe3.mjs.map
