...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const posts = ([__temp, __restore] = withAsyncContext(() => getIncludedYearPosts("record")), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=record-954152c7.mjs.map
