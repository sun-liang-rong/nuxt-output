...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.64338783.mjs').then(interopDefault),
  "pages/search.vue": () => import('./_nuxt/search-styles.cc65f8ae.mjs').then(interopDefault),
